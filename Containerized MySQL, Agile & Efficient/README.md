...
- ✅ Create an SQL initialization script (e.g., `Harsh_demo.sql`) with database and table definitions.
...
COPY Harsh_demo.sql /docker-entrypoint-initdb.d/
...
Create a file named `Harsh_demo.sql` in the same directory:
